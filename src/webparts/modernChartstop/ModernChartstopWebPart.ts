...
import * as strings from 'ModernChartstopWebPartStrings';
import ModernCharts from './components/ModernChartstop';
import { IModernChartstopProps } from './IModernChartstopWebPartProps';
import { MChart } from './IModernChartstopWebPartProps';
import { IModernChartstopWebPartProps } from './IModernChartstopWebPartProps';
import { ChartConfiguration } from './IModernChartstopWebPartProps';
...
export default class ModernChartstopWebPart extends BaseClientSideWebPart<IModernChartstopWebPartProps> {

  private reactCharts: React.ReactElement<IModernChartstopProps>;
  ...
  private getCharts(charts: Array<MChart>): void {
    const chartArea: React.ReactElement<IModernChartstopProps> = React.createElement(
      ModernCharts, {
